    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-card/80 backdrop-blur-md safe-top">
      <div className="flex items-center justify-between h-14 px-3 sm:px-4 gap-2">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
            ...
            <SheetContent side="left" className="w-[85vw] max-w-xs sm:w-72 p-0 flex flex-col">
              <SheetHeader className="p-4 pb-2">
                <div className="flex items-center gap-3">
                  <img src={logoIpnc} alt="IPNC" className="h-10 w-10 object-contain flex-shrink-0" />
                  <SheetTitle className="text-lg truncate">IPNC</SheetTitle>
                </div>
              </SheetHeader>
              <Separator />
          ...
          <span className="font-semibold text-foreground text-base sm:text-lg truncate">IPNC</span>
        </div>
