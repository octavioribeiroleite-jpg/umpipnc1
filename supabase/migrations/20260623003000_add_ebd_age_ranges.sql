...
-- Faixas definidas conforme as salas existentes da igreja.
...
-- 18 a 34 evita que a idade de 35 anos pertença simultaneamente a duas salas.
UPDATE public.ebd_classes
